...
//		assertEquals(true, localComparison);
	...
	@Test
	public final void testLoadProcessWritePdfHTMLHippo() {
		String inputFileName = "Resources/SampleDocs/hippocratesOath.html";
		engine = new Engine(inputFileName, "ANNOTATED", "happyhippoHTML");
		setupProfileHTLMHippo();
		List<String> prefixes = new ArrayList<String>(); 
		...
		String outputFileName = "Resources//Outputs//hippocratesOathHtml.pdf";
		int outputParagraphs = engine.exportPdf(outputFileName);
		assertEquals(17,outputParagraphs);
	}
	
	@Test
	public final void T1_RuleSet_Plain() {
		//create inputSpec list or rules
		
		List<List<String>> inputSpecRuleset = new ArrayList<List<String>>();
		omList = new ArrayList<String>(); inputSpecRuleset.add(omList);
		omList.add("OMIT");omList.add("POSITIONS");omList.add("1,2");
		h1List = new ArrayList<String>(); inputSpecRuleset.add(h1List);
		h1List.add("H1");h1List.add("STARTS_WITH"); h1List.add("POLITICAL ECONOMY");
		boldList = new ArrayList<String>(); inputSpecRuleset.add(boldList);
		boldList.add("<B>");boldList.add("ALL_CAPS");
		
		String outputRuleset = engine.registerInputRuleSetForPlainFiles(inputSpecRuleset).toString();
		String comparisonRuleset = "inputRuleSet\nOMIT: [1, 2]\nH1: POLITICAL ECONOMY\nH2: \nBOLD: enabled\nITALICS: \n";
		assertEquals(outputRuleset, comparisonRuleset);
	}
	
	@Test
	public final void T2_LoadHtml() {
		String inputFileName = "Resources/SampleDocs/hippocratesOath.html";
		engine = new Engine(inputFileName, "ANNOTATED", "happyhippoHTML");
		List<String> prefixes = new ArrayList<String>(); 
		prefixes.add("<H1>");prefixes.add("<H2>");prefixes.add("<i>");prefixes.add("<b>");prefixes.add("<p>");
		...
		int numParagraphs = engine.loadFileAndCharacterizeBlocks();
		assertEquals(numParagraphs, 17);
	}
	
	@Test
	public final void T2_LoadTxt() {
		String inputFileName = "Resources/SampleDocs/hippocratesOath.txt";
		engine = new Engine(inputFileName, "RAW", "happyhippo");
		engine.registerInputRuleSetForPlainFiles(inputSpec);
	...
	@Test
	public final void T3_ShowReport() {
		String inputFileName = "Resources/SampleDocs/hippocratesOath.txt";
		engine = new Engine(inputFileName, "RAW", "happyhippo");
